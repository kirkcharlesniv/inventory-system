 ...
 * Generated for Laravel 5.6.26 on 2018-08-04 18:01:32.
 *
...
namespace Pyaesone17\ActiveState { 
    ...
    class ActiveFacade {
        ...
        {
            return \Pyaesone17\ActiveState\Active::check($url, $deep, $active, $inactive);
        }
        ...
        {
            return \Pyaesone17\ActiveState\Active::checkBoolean($url, $deep, $active, $inactive);
        }
        ...
        {
            return \Pyaesone17\ActiveState\Active::checkRoute($route, $active, $inactive);
        }
        ...
        {
            return \Pyaesone17\ActiveState\Active::checkRouteBoolean($route);
        }
        ...
        {
            return \Pyaesone17\ActiveState\Active::checkQuery($fullUrlWithQuery, $active, $inactive);
        }
        ...
        {
            return \Pyaesone17\ActiveState\Active::checkQueryBoolean($fullUrlWithQuery);
        }
